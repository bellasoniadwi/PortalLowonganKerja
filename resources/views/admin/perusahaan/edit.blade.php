...
@section('content')
    <div class="section-header">
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="/dashboard/toko/{{ $tokos->nama }}/edit">Edit Perusahaan</a></div>
        </div>
    </div>
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12">
                <form method="post" action="/dashboard/toko/{{ strtolower($tokos->nama) }}" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    <div class="card">
                        <div class="card-header">
                            <h4>Form Edit Data Perusahaan</h4>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('pemilik') is-invalid @enderror"
                                        ...
                                        value="{{ old('pemilik', $tokos->pemilik) }}" readonly>
                                    @error('pemilik')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="file" class="form-control @error('image') is-invalid @enderror"
                                        ...
                                        value="{{ old('image') }}">
                                        <img width="80px" height="100"src="{{asset('storage/'. $tokos->image)}}" >
                                    @error('image')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="time" class="form-control @error('jam_buka') is-invalid @enderror"
                                        ...
                                        value="{{ old('jam_buka', $tokos->jam_buka) }}">
                                    @error('jam_buka')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="time" class="form-control @error('jam_tutup') is-invalid @enderror"
                                        ...
                                        value="{{ old('jam_tutup', $tokos->jam_tutup) }}">
                                    @error('jam_tutup')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
